...
[您可以在OpenAPI Explorer中直接运行该接口，免去您计算签名的困扰。运行成功后，OpenAPI Explorer可以自动生成SDK代码示例。](https://api.aliyun.com/#product=CCC&api=UnmuteCall&type=RPC&version=2020-07-01)

## 请求参数

|名称|类型|是否必选|示例值|描述|
|--|--|----|---|--|
|Action|String|是|UnmuteCall|系统规定参数。取值：UnmuteCall。 |
...
|JobId|String|否|job-65382141036853491|话务ID。 |
|ChannelId|String|否|ch:user:139xxxx0501-\>80326034:1609138902226:job-65382141036853491|取消静音的通道ID，如果此参数为空，则表示操作自己所在的通道。 |
...
```
http(s)://[Endpoint]/?Action=UnmuteCall
